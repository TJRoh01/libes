...
use libes::key::Secp256k1;

const LOREM_IPSUM: &'static [u8] = include_bytes!("lorem_ipsum.txt");

#[test]
fn secp256k1_aes256gcm_hmacsha256() {
    // Alias Ecies with algorithms
    type Scheme = Ecies<Secp256k1, Aes256Gcm, HmacSha256>;
    ...
    let pk2 = Secp256k1::try_pk_from(pk_bytes).expect("pk is not correct");
...
#[test]
fn secp256k1_aes256gcm_aead() {
    // Alias Ecies with algorithms
    type Scheme = Ecies<Secp256k1, Aes256Gcm, Aead>;
...
#[test]
fn secp256k1_aes256gcm_syn() {
    // Alias Ecies with algorithms
    type Scheme = Ecies<Secp256k1, Aes256Gcm, Syn>;
